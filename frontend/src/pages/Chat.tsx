    ...
    if (inputMessage.trim()) {
      ...
      setTimeout(() => {
        setMessages(prev => [...prev, { 
          role: 'assistant', 
          content: 'This is a placeholder response. PDF upload and AI integration coming soon!' 
        }]);
      }, 1000);
    }
  };
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
              ...
              <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold">Ask anything about your document</h2>
                <p className="text-muted-foreground max-w-md">
                  Start a conversation with your PDF. Ask questions, request summaries, or extract specific information.
                </p>
              </div>
              <div className="flex flex-wrap gap-2 justify-center max-w-2xl">
                ...
                <Button 
                  variant="glass" 
                  size="sm"
                  onClick={() => setInputMessage("Summarize the main points")}
                >
                ...
                <Button 
                  variant="glass" 
                  size="sm"
                  onClick={() => setInputMessage("Extract key information")}
                >
